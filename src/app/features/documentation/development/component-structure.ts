        ...
        <div class="flex min-w-0 flex-auto flex-col">
            ...
            <div class="prose prose-sm max-w-3xl flex-auto p-6 sm:p-10">
                <fuse-alert [appearance]="'border'" [type]="'info'">
                    <span>
                        Fuse uses route based component loading strategy. There
                        are componentless and empty-path routes specifically
                        structured to load components without hard coding them
                        into templates. This provides great extensibility and
                        scalability to the app and we strongly suggest you to
                        follow the same path.
                    </span>
                </fuse-alert>
                <p>
                    Here's the diagram of the Fuse's default component structure
                    for the reference:
                </p>
                        ...
                        >
                            ...
                            >
                                ...
                                <div class="flex h-full w-full">
                                    <!-- Navigation -->
                                    <div
                                        class="relative w-1/4 border-r-2 border-green-400"
                                    >
                                        <span
                                    ...
                                    <div class="flex w-3/4 flex-col">
                                        ...
                                        <!-- Content -->
                                        <div
                                            class="relative flex w-full flex-auto"
                                        >
                                            <span
                                                class="absolute left-0 top-0 p-3 pl-6 font-medium text-green-700"
                                                >&lt;router-outlet&gt;</span
                ...
                <h2>AppComponent</h2>
                <p>
                    This is the entry point of the application. It imports all
                    the necessary modules in order for Fuse and your app to
                    work. All 3rd party modules also imported and configured
                    here.
                </p>

                <h2>LayoutComponent</h2>
                <p>
                    This component makes the layout switching easier. Fuse
                    provides variety of different layouts like
                    <strong>ClassicLayout</strong> or
                    <strong>EnterpriseLayout</strong> and this component can
                    load or switch those layouts at any time.
                </p>
                <p>
                    To understand how <strong>LayoutComponent</strong> works,
                    look at this portion of the
                    <code>app.routing.ts</code> file:
                </p>
                ...
                >
                <p>
                    As you can see, there is an empty-path route at the
                    beginning of the
                    <strong>Admin</strong> routes which essentially loads the
                    <code>LayoutComponent</code> into the
                    <code>&lt;router-outlet&gt;</code> of the
                    <em>AppComponent</em>.
                </p>
                <p>
                    After that, <code>LayoutComponent</code> loads the selected
                    layout. All layouts includes a
                    <code>&lt;router-outlet&gt;</code> in their templates which
                    then loads the actual component that's being requested
                ...
                <p>
                    ...
                    <code>app/layout/layouts/</code> directory and these layouts
                    include common components like <strong>Navigation</strong>,
