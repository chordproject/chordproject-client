    ...
    template: `
        <div class="flex min-w-0 flex-auto flex-col">
            ...
            <div class="prose prose-sm max-w-3xl flex-auto p-6 sm:p-10">
                <p>
                    This component can be used for searching. It will make API
                    calls as you start typing the search query into the search
                    field and show the results in the
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <strong>basic</strong> will show a simple
                                    search field. <strong>bar</strong> will show
                                    a dropdown bar that covers the header.
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Minimum length of the search value required
