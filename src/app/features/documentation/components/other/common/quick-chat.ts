    ...
    template: `
        <div class="flex min-w-0 flex-auto flex-col">
            ...
            <div class="prose prose-sm max-w-3xl flex-auto p-6 sm:p-10">
                <p>
                    Quick Chat is a simple component to show a Chat sidebar
                    across the entire layout. You can remove the component from
                    the template file of your preferred layout to remove the
                    Quick Chat completely.
                </p>
