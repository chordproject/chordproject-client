    ...
    template: `
        <div class="flex min-w-0 flex-auto flex-col">
            ...
            <div class="prose prose-sm max-w-3xl flex-auto p-6 sm:p-10">
                <p>
                    This component can be used for showing information and
                    actions related to the currently logged in user.
                </p>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    Whether to show avatar of the user. If set
                                    to
                                    <code>false</code>, a generic icon will be
                                    shown.
                                </td>
                                <td>
