    ...
    template: `
        <div class="flex min-w-0 flex-auto flex-col">
            ...
            <div class="prose prose-sm max-w-3xl flex-auto p-6 sm:p-10">
                <p>
                    This component can be used to show latest notifications in a
                    custom made panel. These notifications can be either system
                    wide or applications that sent to the currently logged in
                ...
                <p>
                    The <code>NotificationsService</code> can be used to control
                    the notifications outside of the
                    <strong>Notifications</strong> component. This is
                    particularly useful to control the notifications from other
                    components for actions like creating, updating or deleting
                    them.
                </p>
