    ...
    template: `
        <div class="flex min-w-0 flex-auto flex-col">
            ...
            <div class="prose prose-sm max-w-3xl flex-auto p-6 sm:p-10">
                <p>
                    <strong>FuseSplashScreenService</strong> is a singleton
                    service to control the splash screen. By default, the splash
                    screen goes away automatically as soon as Angular loads for
                    the first time but, you can still show or hide it using the
                    service afterwards.
                </p>
