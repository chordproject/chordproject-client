    ...
    template: `
        <div class="flex min-w-0 flex-auto flex-col">
            ...
            <div class="prose prose-sm max-w-3xl flex-auto p-6 sm:p-10">
                <p>
                    <strong>fuse-alert</strong> is a customizable component for
                    displaying all kinds of alerts across your app. They can be
                    controlled from your components as well as from the
                    <code>FuseAlertService</code>.
                </p>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    A unique name for the alert box to access it
                                    from
                                    <code>FuseAlertService</code>.
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>Appearance of the alert box.</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>Whether the alert box is dismissed.</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Whether the alert box is dismissible. This
                                    must be
                                    <code>true</code> for
                                    <code>dismissed</code> to work.
                                </td>
                                <td>
                                    <code class="whitespace-nowrap">false</code>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>Whether the icon is shown.</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>The type of the alert box.</td>
                                <td>
                                    <code class="whitespace-nowrap"
                                        >primary</code
                                    >
                            ...
                            <tr>
                                ...
                                <td>
                                    An event emitted after the alert box
                                    dismissed.
                                </td>
                                <td>-</td>
                            </tr>
                ...
                <h2>Appearance</h2>
                <p>
                    Alert component comes with 3 different built-in appearances
                    to choose from:
                </p>
                        ...
                        <mat-tab label="Preview" class="bg-gray-200">
                            <ng-template matTabContent>
                                ...
                                <fuse-alert [type]="'info'">
                                    ...
                                    This is a alert with an 'info' level
                                    severity
                                </fuse-alert>
                                ...
                                <fuse-alert [type]="'success'">
                                    ...
                                    This is a alert with a 'success' level
                                    severity
                                </fuse-alert>
                                ...
                                <fuse-alert [type]="'warning'">
                                    ...
                                    This is a alert with a 'warning' level
                                    severity
                                </fuse-alert>
                                ...
                                <fuse-alert [type]="'error'">
                                    ...
                                    This is a alert with an 'error' level
                                    severity
                                </fuse-alert>
                            </ng-template>
                        </mat-tab>
                ...
                <p>
                    All alert boxes have <strong>title</strong> and
                    <strong>alert</strong> content that can be customized.
                </p>
                    ...
                    <mat-tab-group [animationDuration]="'0ms'">
                        <mat-tab label="Preview">
                            <ng-template matTabContent>
                                ...
                                >
                                    <span fuseAlertTitle
                                        >Alert title without any content</span
                                    >
                                </fuse-alert>
                ...
                <h2>Icons</h2>
                <p>
                    The <strong>info</strong>, <strong>success</strong>,
                    <strong>warning</strong> and <strong>error</strong> type
                    alert boxes have default icons and they are visible by
                    default. If you wish to hide those icons, use the
                    <code>[showIcon]="false"</code> input.
                </p>
                ...
                <h2>Custom icons</h2>
                <p>
                    All alert boxes come with custom icon support. To use a
                    custom icon, simply use <code>fuseAlertIcon</code> attribute
                    on an element you wish to use as the icon. If there is a
                    default icon for the alert box, custom icon will override
                    it.
                </p>
                ...
                <p>
                    Dismissible alerts can be removed from the view by clicking
                    their
                    <strong>dismiss (x)</strong> button. In order to get the
                    dismiss button visible, the <code>[dismissed]</code> input
                    must be explicitly set either to <code>true</code> or
                    <code>false</code>. Setting the
                    <code>[dismissed]</code> input to <code>null</code> or
                    simply removing it from the element will remove the
                        ...
                        <mat-tab label="Preview">
                            <ng-template matTabContent>
                                <fuse-alert
                                    ...
                                    [type]="'success'"
                                >
                                    Your subscription model is successfully
                                    upgraded to the <b>Lifetime Pro</b>.
                                </fuse-alert>
                                ...
                                <fuse-alert
                                    ...
                                    [type]="'info'"
                                >
                                    This one has a lot of text so you can see
                                    how the text is going to be displayed. Also
                                    this is a dismissible alert box which can be
                                    dismissed by clicking the
                                    <b>dismiss</b> button.
                                </fuse-alert>
                            </ng-template>
                        </mat-tab>
                ...
                <p>
                    Alerts can be shown and dismissed via
                    <code>FuseAlertService</code>.
                </p>
