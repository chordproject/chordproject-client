    ...
    template: `
        <div class="flex min-w-0 flex-auto flex-col">
            ...
            <div class="prose prose-sm max-w-3xl flex-auto p-6 sm:p-10">
                <p>
                    <strong>fuse-card</strong> is a basic card component to show
                    any kind of information or content with features like
                    flipping and expanding.
                </p>
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Whether the card is flippable.</td>
                                <td>
                ...
                <div class="bg-card mt-4 rounded shadow">
                    ...
                    <div class="p-6">Expands the expansion of the card.</div>
                </div>
                <div class="bg-card mt-4 rounded shadow">
                    <div class="text-secondary border-b px-6 py-3 font-mono">
                        collapse(): void
                    </div>
                    <div class="p-6">Collapses the expansion of the card.</div>
                </div>
                <div class="bg-card mt-4 rounded shadow">
                    <div class="text-secondary border-b px-6 py-3 font-mono">
                        toggleExpanded(): void
                ...
                <div class="bg-card mt-4 rounded shadow">
                    ...
                    <div class="p-6">Flip the card.</div>
                </div>

                <h2>Usage</h2>
                <p>
                    Just wrap the content or the information with
                    <code>fuse-card</code> to show them within the card.
                    <strong>fuse-card</strong> doesn't apply any kind of style
                    to its content to make customization simpler:
                </p>
                            ...
                            <ng-template matTabContent>
                                <div class="bg-gray-100 p-4">
                                    <div class="mx-auto max-w-80">
                                        <fuse-card>
                                            This content is in the card and it
                                            doesn't have any style applied to
                                            it!
                                        </fuse-card>
                                    </div>
                                </div>
                ...
                <h3>Expandable</h3>
                <p>
                    Expandable <strong>fuse-card</strong> holds an extra content
                    or information hidden in its expandable area which can be
                    toggled by accessing the component itself via a template
                    reference:
                </p>
                                ...
                                <div class="bg-gray-100 p-4">
                                    <div class="mx-auto max-w-80">
                                        ...
                                        >
                                            ...
                                            <div class="mt-2">
                                                A paragraph, an image, a form or
                                                simply anything can go here to
                                            ...
                                            <ng-container fuseCardExpansion>
                                                <div class="my-2">
                                                    This is the expansion and
                                                    holds an extra information!
                                                </div>
                                            </ng-container>
                                        </fuse-card>
                                    </div>
                ...
                <h3>Flippable</h3>
                <p>
                    Flippable card holds content or information on both sides
                    and can be flipped by accessing the component itself via a
                    template reference. The only limitation with this type of
                    cards is that the
                    <em>back</em> of the card will share the same height as the
                    <em>front</em> of the card. If the <em>back</em> side has
                    more content, scrollbar will appear.
                </p>
                                    ...
                                    <div class="mx-auto max-w-80">
                                        ...
                                        >
                                            ...
                                            <ng-container fuseCardFront>
                                                <div
                                                    class="flex flex-col px-8 py-6 pb-3"
                                                >
                                                    <div
                                                    ...
                                                    <div class="mt-2">
                                                        A paragraph, an image, a
                                                        form or simply anything
                                                        can go here to create
                                                        the content of the card.
                                                    </div>
                                                    <div
                                                        class="-mx-3 mt-3 self-end"
                                                    >
                                                        <button
                                                            mat-icon-button
                                                            [color]="'primary'"
                                            ...
                                            <ng-container fuseCardBack>
                                                <div
                                                    class="flex flex-auto flex-col px-8 py-6 pt-3"
                                                >
                                                    <div class="-mx-3 mb-2">
                                                        <button
                                                            mat-icon-button
