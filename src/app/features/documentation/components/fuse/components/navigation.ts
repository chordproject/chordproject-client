    ...
    template: `
        <div class="flex min-w-0 flex-auto flex-col">
            ...
            <div class="prose prose-sm max-w-3xl flex-auto p-6 sm:p-10">
                <p>
                    <strong>fuse-navigation</strong> is a set of components for
                    creating navigations from data. It has two different
                    variations; <strong>fuse-vertical-navigation</strong> for
                    creating vertical and
                    <strong>fuse-horizontal-navigation</strong> for creating
                    horizontal navigations.
                </p>
                <p>
                    The <em>vertical</em> navigation comes with built-in drawer
                    that can be programmed in various ways to show the
                    navigation in different styles and to control the mobile
                    behavior.
                </p>
                <p>
                    <strong>fuse-navigation</strong> also provides a service
                    which can be used to store navigation data as well as
                    accessing navigation items with their ids from the
                    navigation data. It's a utility service, you don't have to
                    use it to make <strong>fuse-navigation</strong> work.
                </p>
                <p>
                    <strong>Exported as: </strong
                    ><code>fuseVerticalNavigation</code> and
                    <code>fuseHorizontalNavigation</code>
                </p>

                <fuse-alert [appearance]="'border'" [type]="'info'">
                    fuse-navigation designed to work with data and it must be
                    supplied in certain format. If you want to create a
                    navigation from an HTML structure, this component is not for
                    you.
                </fuse-alert>
                ...
                <p>
                    ...
                    <em>vertical</em> and <em>horizontal</em> navigation items
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    Unique id of the navigation item. It's
                                    important to supply navigation items with
                                    ids if you want to access and modify them
                            ...
                            <tr>
                                ...
                                <td>
                                    A function that returns a boolean. It gets
                                    one parameter which is the navigation item.
                                    Returning
                                    <code>true</code> from the function will
                                    hide the item and <code>false</code> will
                                    show it.
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    Whether to force the navigation item to be
                                    active.
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    Tooltip to show on item hover. Empty string
                                    will remove the tooltip.
                                </td>
                            </tr>
                            <tr>
                                <td class="text-secondary font-mono text-md">
                                ...
                                <td>
                                    String representation of the item link. It
                                    can be either a <em>router</em> link or a
                            ...
                            <tr>
                                ...
                                <td>
                                    When true, preserves the URL fragment for
                                    the next navigation.
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    How to handle query parameters in the router
                                    link for the next navigation.
                                </td>
                            </tr>
                            <tr>
                                <td class="text-secondary font-mono text-md">
                                ...
                                <td>
                                    Whether the supplied link should be parsed
                                    as an external link. It must be
                                    <strong>true</strong> if you supply a
                                    normal, outgoing link in the
                            ...
                            <tr>
                                ...
                                <td>
                                    Sets the <em>target</em> attribute of the
                            ...
                            <tr>
                                ...
                                <td>
                                    Sets the
                                    <em>isActiveMatchOptions</em> object on the
                                    <em>[routerLinkActiveOptions]</em>. If
                                    provided, <em>exactMatch</em> option will be
                                    ignored.
                                    <a
                            ...
                            <tr>
                                ...
                                <td>
                                    A function to run on navigation item click.
                                    It gets one parameter which is the
                                    navigation item. Supplying function will
                                    <strong>NOT</strong>
                                    override the link functionality of the
                                    navigation item, they will run in parallel.
                                </td>
                            </tr>
                            <tr>
                                <td class="text-secondary font-mono text-md">
                                ...
                                <td>
                                    Custom class names for the navigation item's
                                    specific parts. Multiple class names can be
                                    added by separating them with whitespace:
                            ...
                            <tr>
                                ...
                                <td>
                                    Classes to add to the badge. This can be
                                    used to customize the look of the badge.
                                </td>
                            </tr>
                            <tr>
                                <td class="text-secondary font-mono text-md">
                                ...
                                <td>
                                    Array of navigation items to create child
                                    items.
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    An object to hold custom data for the
                                    navigation item. It can be used for anything
                                    such as storing the access role and
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    Appearance of the navigation and its drawer.
                                    This is a string type and can be used to
                                    override the style of the navigation.
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Whether expanding an expandable navigation
                                    item should close other expanded items
                                    excluding the active menu item's parent.
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Whether the inner mode is active. This mode
                                    allows using navigation without its drawer.
                                    Suitable for using it inside
                                    <strong>mat-sidenav</strong> or
                            ...
                            <tr>
                                ...
                                <td>
                                    <strong>over</strong> mode can be used to
                                    place the drawer on top of the content and
                                    <strong>side</strong> mode can be used to
                                    push the content and place the drawer next
                                    to it.
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Unique name of the navigation. Required for
                                    navigation and its drawer to work correctly.
                                </td>
                                <td>-</td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    Array of navigation items to build the
                                    navigation from.
                                </td>
                                <td>-</td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    Whether the navigation drawer is opened.
                                    Only works with <strong>over</strong> mode.
                                </td>
                                <td>
                                    <code class="whitespace-nowrap">false</code>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    Whether the overlay of the drawer is
                                    transparent. Only works with
                            ...
                            <tr>
                                ...
                                <td>
                                    An event emitted after the appearance of the
                                    navigation changed.
                                </td>
                                <td>-</td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    An event emitted after the mode of the
                                    navigation changed.
                                </td>
                                <td>-</td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    An event emitted after the opened status of
                            ...
                            <tr>
                                ...
                                <td>
                                    An event emitted after the position of the
                                    navigation changed.
                                </td>
                                <td>-</td>
                            </tr>
                ...
                <p>
                    Since the entire navigation will be created from the
                    supplied navigation data, it's only possible to attach
                    custom content inside the navigation drawer using custom
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    Fixed header hook. Anything put inside this
                                    hook will not scroll with drawer content.
                                </td>
                            </tr>
                            <tr>
                                <td class="text-secondary font-mono text-md">
                                ...
                                <td>
                                    Header hook. Anything put inside this hook
                                    will be scrolled with the drawer content.
                                </td>
                            </tr>
                            <tr>
                                <td class="text-secondary font-mono text-md">
                                ...
                                <td>
                                    Fixed footer hook. Anything put inside this
                                    hook will not scroll with drawer content.
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    Footer hook. Anything put inside this hook
                                    will be scrolled with the drawer content.
                                </td>
                            </tr>
                        </tbody>
                ...
                <p>
                    The <code>FuseNavigationService</code> provides couple
                    helper methods to access navigation items from the
                    navigation data using their ids. This is especially useful
                    if you want to change something from any item like updating
                    its badge title, hiding or disabling it.
                </p>
                ...
                <p>
                    After accessing a navigation item, you can simply modify the
                    object and then call the <code>refresh()</code> method on
                    the <em>Navigation component</em> to apply the changes.
                </p>
                <div class="example-viewer">
                    <div class="title">
                        ...
                        <mat-tab label="Preview">
                            <ng-template matTabContent>
                                <button
                                    ...
                                    "
                                >
                                    Toggle the disabled status of 'Changelog'
                                    item
                                </button>
                            </ng-template>
                        </mat-tab>
                ...
                <p>
                    Sometimes it's best to use more than one set of data and
                    swap between them to provide correct navigation. An example
                    use case would be user roles. Different roles may require
                    access to different areas and rather than showing/hiding
                    individual navigation items, it's best to swap the entire
                    navigation data to show a personalized navigation for that
                    role.
                </p>
                <div class="example-viewer">
                    <div class="title">
                        ...
                        <mat-tab label="Preview">
                            <ng-template matTabContent>
                                <fuse-alert appearance="outline" type="info">
                                    Reload the page to load the default
                                    navigation!
                                </fuse-alert>
                                <button
                                    class="mt-4"
                                    ...
                                    [color]="'primary'"
                                    (click)="
                                        swapNavigationData('mainNavigation')
                                    "
                                >
