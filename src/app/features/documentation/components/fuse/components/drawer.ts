  ...
  template: `
    <div class="flex min-w-0 flex-auto flex-col">
      ...
      <div class="prose prose-sm max-w-3xl flex-auto p-6 sm:p-10">
        <p>
          <strong>fuse-drawer</strong> is a simple drawer component that can be
          programmed in various ways. The main difference between Angular
          Material's <strong>mat-drawer</strong> component is that the
          <strong>fuse-drawer</strong> can be placed anywhere on the DOM and it
          doesn't have to wrap the content like <strong>mat-drawer</strong>.
        </p>
        <fuse-alert [appearance]="'border'" [type]="'info'">
          Since fuse-drawer works with <em>absolute</em> positioning by default,
          the parent of the drawer must have <code>position: relative</code> and
          <code>overflow-x: hidden</code> properties otherwise the drawer won't
          be able to work correctly.
        </fuse-alert>
        <p><strong>Exported as: </strong><code>fuseDrawer</code></p>
        ...
        <h2>Usage</h2>
        <p>Here's the basic usage of the <code>fuse-drawer</code>:</p>
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  Whether the position of the drawer is
                  <em>fixed</em> or <em>absolute</em>.
                </td>
                <td>
              ...
              <tr>
                ...
                <td>
                  Unique name of the drawer. Required for drawer to work
                  correctly.
                </td>
                <td>-</td>
              </tr>
              <tr>
                ...
                <td>
                  Whether the drawer is opened. Only works with
              ...
              <tr>
                ...
                <td>
                  An event emitted after the opened status of the drawer
                  changed.
                </td>
                <td>-</td>
              </tr>
        ...
        <h2>Service</h2>
        <p>
          The <code>FuseDrawerService</code> can be used to remotely accessing
          to drawers using their <strong>name</strong> properties to control
          them:
        </p>
          ...
          <mat-tab-group [animationDuration]="'0ms'">
            <mat-tab label="Preview">
              <ng-template matTabContent>
                <button mat-flat-button (click)="toggleDrawerMode()">
                  Toggle drawer mode
                </button>
                ...
                <div class="relative mt-8 flex min-h-80 overflow-hidden border">
                  <fuse-drawer
                    [name]="'leftDrawer'"
                    [opened]="drawerOpened"
                    [mode]="drawerMode"
                  ...
                  <div class="flex-auto bg-gray-100 p-4">Some content</div>
                </div>
              </ng-template>
            </mat-tab>
