    ...
    template: `
        <div class="flex min-w-0 flex-auto flex-col">
            ...
            <div class="prose prose-sm max-w-3xl flex-auto p-6 sm:p-10">
                <p>
                    <strong>fuse-drawer</strong> is a simple drawer component
                    that can be programmed in various ways. The main difference
                    between Angular Material's
                    <strong>mat-drawer</strong> component is that the
                    <strong>fuse-drawer</strong> can be placed anywhere on the
                    DOM and it doesn't have to wrap the content like
                    <strong>mat-drawer</strong>.
                </p>
                <fuse-alert [appearance]="'border'" [type]="'info'">
                    Since fuse-drawer works with <em>absolute</em> positioning
                    by default, the parent of the drawer must have
                    <code>position: relative</code> and
                    <code>overflow-x: hidden</code> properties otherwise the
                    drawer won't be able to work correctly.
                </fuse-alert>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    Unique name of the drawer. Required for
                            ...
                            <tr>
                                ...
                                <td>
                                    Whether the drawer is opened. Only works
                                    with
                ...
                <h2>Service</h2>
                <p>
                    The <code>FuseDrawerService</code> can be used to remotely
                    accessing to drawers using their
                    <strong>name</strong> properties to control them:
                </p>
                    ...
                    <mat-tab-group [animationDuration]="'0ms'">
                        <mat-tab label="Preview">
                            <ng-template matTabContent>
                                ...
                                <div
                                    class="relative mt-8 flex min-h-80 overflow-hidden border"
                                >
                                    <fuse-drawer
                                        [name]="'leftDrawer'"
                                        [opened]="drawerOpened"
