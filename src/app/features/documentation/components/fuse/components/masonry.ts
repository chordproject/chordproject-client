    ...
    template: `
        <div class="flex min-w-0 flex-auto flex-col">
            ...
            <div class="prose prose-sm max-w-3xl flex-auto p-6 sm:p-10">
                <p>
                    <strong>fuse-masonry</strong> is a basic Masonry layout
                    component to show items in Masonry grid layout. Since it
                    doesn't use any other third party library or complex
                    calculations to keep everything smooth and fast;
                </p>
                <ul>
                    <li>
                    ...
                    <li>
                        It does NOT sort items based on their heights (This here
                        is the real performance killer)
                    </li>
                </ul>
                <p>
                    If you don't need to mix and match different width items and
                    don't need to sort items based on their heights,
                    <strong>fuse-masonry</strong> will do the job for you and it
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    Column template for masonry component to lay
                                    out.
                                </td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>Number of columns to create</td>
                                <td>
                                    <code class="whitespace-nowrap"
                                        >undefined</code
                                    >
                            ...
                            <tr>
                                ...
                                <td>Items to distribute into columns</td>
                                <td>
                ...
                <h2>Usage</h2>
                <p>
                    <strong>fuse-masonry</strong> doesn't provide a default
                    template or styling to the items. You can think of it as a
                    helper function but in a component form:
                </p>
                                    ...
                                    <div class="mx-auto max-w-80">
                                        ...
                                        >
                                            @for (
                                                ...
                                                <!-- Column -->
                                                <div
                                                    class="mx-2 flex-1 space-y-2 rounded border p-2"
                                                >
                                                    @for (
                ...
                <h3>Responsive</h3>
                <p>
                    <strong>fuse-masonry</strong> doesn't provide a way of
                    changing the column count depending on breakpoints but this
                    can easily be handled by combining
                    <code>fuse-masonry</code> with
                    <code>FuseMediaWatcherService</code>:
                </p>
...
export default class Masonry implements OnInit {
    columns: number = 4;
