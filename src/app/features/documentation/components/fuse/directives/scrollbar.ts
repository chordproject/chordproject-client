    ...
    template: `
        <div class="flex min-w-0 flex-auto flex-col">
            ...
            <div class="prose prose-sm max-w-3xl flex-auto p-6 sm:p-10">
                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    Whether to enable or disable the custom
                                    scrollbars.
                                </td>
                                <td>
                ...
                <h2>Methods</h2>
                <p>
                    It's possible to access the methods of this directive using
                    a
                ...
                <div class="bg-card mt-4 rounded shadow">
                    ...
                    <div class="p-6">
                        ...
                        (scrollLeft, scrollTop, scrollHeight, scrollWidth etc.)
                    </div>
                </div>
                <div class="bg-card mt-4 rounded shadow">
                    <div class="text-secondary border-b px-6 py-3 font-mono">
                ...
                <div class="bg-card mt-4 rounded shadow">
                    <div class="text-secondary border-b px-6 py-3 font-mono">
                        scrollToElement(qs: string, offset: number = 0,
                        ignoreVisible: boolean = false, speed?: number): void
                    </div>
                    <div class="p-6">
                        Scrolls to found element based on the given
                        <strong>QuerySelector</strong>. If
                        <code>ignoreVisible</code> is <strong>true</strong> then
                        scroll won't be triggered if the element is already
