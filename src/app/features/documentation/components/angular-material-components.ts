...
@Component({
    selector: 'angular-material-components',
            ...
            <div class="flex-auto p-6 sm:p-10">
                <div class="prose prose-sm max-w-4xl">
                    <p>
                        ...
                        as its primary user interface library. It offers form
                        controls, buttons, tabs, sidebars, icons, modals,
                        tooltips, data tables and many more well tested and
                        widely used components.
                    </p>
                    <p>
                        Even though Fuse doesn't follow Google's Material design
                        specifications, Angular Material is one of the best
                        Angular component libraries out there and since it's
                        developed and maintained by Google itself, it offers the
                        best compatibility and support for Angular.
                    </p>
                    <p>
                        Fuse is 100% compatible with all Angular Material
                        components.
                    </p>

                    <h2>Component examples and API documentation</h2>
                    <p>
                        Following, you can find links to the official
                        documentation. Click on the component you want to learn
                        more about and it will redirect you to the related
                        section of the official documentation.
                    </p>
                </div>

                <div
                    class="mt-8 grid grid-cols-1 gap-10 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5"
                >
                    @for (component of components; track component) {
                        <a
                            class="bg-card flex flex-col overflow-hidden rounded-2xl shadow transition-shadow duration-200 ease-in-out hover:shadow-xl"
                            [href]="
                        ...
                        >
                            <img
                                ...
                                [src]="
                                    'images/ui/angular-material/scenes/' +
                                    component.id +
                                    '.scene.png'
                                "
                            />
...
export default class AngularMaterialComponents {
    components: any[];
