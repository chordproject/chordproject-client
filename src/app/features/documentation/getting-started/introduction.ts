    ...
    <div class="flex min-w-0 flex-auto flex-col">
      ...
      <div class="prose prose-sm max-w-3xl flex-auto p-6 sm:p-10">
        ...
        <p>
          ...
          custom made Application and Page layouts, UI elements and UX best
          practices.
        </p>
        <p>
        ...
        <p>
          ...
          <strong>Angular Material</strong> and <strong>TailwindCSS</strong>:
        </p>
        <ul>
          <li>
          ...
          <li>
            ...
            <p>
              Provides the main UI components such as Buttons, Form fields,
              Tabs, Progress bars and more.
            </p>
          </li>
          <li>
            ...
            <p>
              It is the core of the style configuration and it provides utility
              classes for almost every CSS rule available.
            </p>
          </li>
        </ul>
      </div>
