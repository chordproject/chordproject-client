    ...
    template: `
        <div class="flex min-w-0 flex-auto flex-col">
            ...
            <div class="prose prose-sm max-w-3xl flex-auto p-6 sm:p-10">
                <p>
                    After the installation process finishes, run the following
                    command while still in your workspace directory:
                </p>
                ...
                >
                <p>
                    The <code>ng serve</code> command launches the server,
                    watches your files, and rebuilds the app as you make changes
                    to those files.
                </p>
                <p>
                    The <code>--open</code> (or just <code>-o</code>) option
                ...
                <fuse-alert [appearance]="'border'" [type]="'info'">
                    ...
                    <code>ng serve --open</code> or
                    <code>npm start</code> commands, you may have an older
                    Node.js version, try updating your Node.js to the latest LTS
