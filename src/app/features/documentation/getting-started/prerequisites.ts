  ...
  template: `
    <div class="flex min-w-0 flex-auto flex-col">
      ...
      <div class="prose prose-sm max-w-3xl flex-auto p-6 sm:p-10">
        ...
        <h2>2. npm</h2>
        <p>
          To download and install npm packages, you must have the npm package
          manager. This guide uses the npm client command line interface, which
          is installed with Node.js by default. To check that you have the npm
          client installed, run
        ...
        <p>
          ...
          a variety of ongoing development tasks such as testing, bundling, and
          deployment.
        </p>
        <p>
