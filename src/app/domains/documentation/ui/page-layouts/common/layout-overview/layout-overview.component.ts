    ...
    <div class="mx-auto w-full max-w-320 px-6 md:px-8">
      <div class="py-8">
        ...
        <div>
          ...
          <div class="text-muted text-lg md:text-xl">
          ...
          <div>
            ...
            >
              <div class="flex min-h-full flex-auto">
                ...
                <div class="flex flex-auto flex-col">
                  ...
                  >
                    <ng-container
                      *ngComponentOutlet="selectedOption.component"
                    ></ng-container>
                  </div>
                  <!-- Footer -->
                  <div
            ...
            <div class="mt-8 flex items-center justify-between">
              <div>
                ...
                <div class="mt-1">
                  <code class=""
                    >/src/app/modules/admin{{ selectedOption.link }}/</code
                  >
                </div>
              </div>
              @if (selectedOption.link) {
                <div>
                  <a mat-flat-button [routerLink]="selectedOption.link">
                    <mat-icon
                      class="icon-size-4"
