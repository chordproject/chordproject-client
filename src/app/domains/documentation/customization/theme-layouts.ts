    ...
    <div class="flex min-w-0 flex-auto flex-col">
      ...
      <div class="prose prose-sm max-w-3xl flex-auto p-6 sm:p-10">
        <p>
          ...
          can completely alter the look of your app.
        </p>
        <p>
        ...
        <p>
          ...
          service, <code>LayoutComponent</code> will also read the current route
          tree, walk through it starting from the root all the way to the
          current route and look for the <strong>layout</strong> key-value from
          the <em>data</em> object. If found,
