    ...
    <div class="flex min-w-0 flex-auto flex-col">
      ...
      <div class="prose prose-sm max-w-3xl flex-auto p-6 sm:p-10">
        <p>
          ...
          components as well as from the <code>FuseAlertService</code>.
        </p>
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  A unique name for the alert box to access it from
              ...
              <tr>
                ...
                <td>
                  Whether the alert box is dismissible. This must be
                  <code>true</code> for <code>dismissed</code> to work.
                </td>
                <td>
                  <code class="whitespace-nowrap">false</code>
                </td>
              ...
              <tr>
                ...
                <td>An event emitted after the alert box dismissed.</td>
                <td>-</td>
              </tr>
              <tr>
                <td class="text-muted font-mono">
                ...
                <td>An event emitted after the alert box shown.</td>
                <td>-</td>
              </tr>
            </tbody>
          </table>
        ...
        <h2>Appearance</h2>
        <p>
          Alert component comes with 3 different built-in appearances to choose
          from:
        </p>
        ...
        <p>
          ...
          <strong>warning</strong> and <strong>error</strong> type alert boxes
          have default icons and they are visible by default. If you wish to
          hide those icons, use the <code>[showIcon]="false"</code> input.
        </p>
        ...
        <h2>Custom icons</h2>
        <p>
          All alert boxes come with custom icon support. To use a custom icon,
          simply use <code>fuseAlertIcon</code> attribute on an element you wish
          to use as the icon. If there is a default icon for the alert box,
          custom icon will override it.
        </p>
        ...
        <p>
          Dismissible alerts can be removed from the view by clicking their
          <strong>dismiss (x)</strong> button. In order to get the dismiss
          button visible, the <code>[dismissed]</code> input must be explicitly
          set either to <code>true</code> or <code>false</code>. Setting the
          <code>[dismissed]</code> input to <code>null</code> or simply removing
          it from the element will remove the <strong>dismiss</strong> button.
        </p>
            ...
            <mat-tab label="Preview">
              <ng-template matTabContent>
                ...
                <fuse-alert
                  ...
                  [type]="'info'"
                >
                  This one has a lot of text so you can see how the text is
                  going to be displayed. Also this is a dismissible alert box
                  which can be dismissed by clicking the
                  <b>dismiss</b> button.
                </fuse-alert>
              </ng-template>
            </mat-tab>
