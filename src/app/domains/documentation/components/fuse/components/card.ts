    ...
    <div class="flex min-w-0 flex-auto flex-col">
      ...
      <div class="prose prose-sm max-w-3xl flex-auto p-6 sm:p-10">
        ...
        <div class="bg-card mt-4 rounded shadow">
          ...
          <div class="p-6">Toggles the expanded status of the expansion.</div>
        </div>
        <div class="bg-card mt-4 rounded shadow">
          <div class="text-muted border-b px-6 py-3 font-mono">
            flip(): void
        ...
        <p>
          ...
          <strong>fuse-card</strong> doesn't apply any kind of style to its
              ...
              <ng-template matTabContent>
                <div class="bg-gray-100 p-4">
                  <div class="mx-auto max-w-80">
                    <fuse-card>
                      This content is in the card and it doesn't have any style
                      applied to it!
                    </fuse-card>
                  </div>
                </div>
        ...
        <h3>Expandable</h3>
        <p>
          Expandable <strong>fuse-card</strong> holds an extra content or
          information hidden in its expandable area which can be toggled by
          accessing the component itself via a template reference:
        </p>
                  ...
                  <div class="mx-auto max-w-80">
                    <fuse-card class="flex flex-col px-8 py-6 pb-4" #fuseCard>
                      ...
                      <div class="mt-2">
                        ...
                        here to create the content of the card.
                      </div>
                      <div class="-mx-3 mt-3">
                        <button
                          class="px-3"
        ...
        <h3>Flippable</h3>
        <p>
          Flippable card holds content or information on both sides and can be
          flipped by accessing the component itself via a template reference.
          The only limitation with this type of cards is that the
          <em>back</em> of the card will share the same height as the
          <em>front</em> of the card. If the <em>back</em> side has more
          content, scrollbar will appear.
        </p>
                    ...
                    >
                      ...
                      <ng-container fuseCardFront>
                        <div class="flex flex-col px-8 py-6 pb-3">
                          <div class="text-lg font-bold">Title of the card</div>
                          <div class="mt-2">
                            A paragraph, an image, a form or simply anything can
                            go here to create the content of the card.
                          </div>
                          <div class="-mx-3 mt-3 self-end">
                            <button
                              mat-icon-button
                      ...
                      <ng-container fuseCardBack>
                        <div class="flex flex-auto flex-col px-8 py-6 pt-3">
                          <div class="-mx-3 mb-2">
                            <button
                              mat-icon-button
                          ...
                          <p class="text-muted">
                            This is the back of the card and holds an extra
                            information!
                          </p>
                          <p class="text-muted">
                            Also, the
                            <em>back</em> side of the card holds more
                            information than the <em>front</em> of the card
