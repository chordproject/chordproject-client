    ...
    <div class="flex min-w-0 flex-auto flex-col">
      ...
      <div class="prose-sm prose max-w-3xl flex-auto p-6 sm:p-10">
        <p>
          ...
          <strong>fuse-vertical-navigation</strong> for creating vertical and
          <strong>fuse-horizontal-navigation</strong> for creating horizontal
          navigations.
        </p>
        <p>
          The <em>vertical</em> navigation comes with built-in drawer that can
          be programmed in various ways to show the navigation in different
          styles and to control the mobile behavior.
        </p>
        <p>
          <strong>fuse-navigation</strong> also provides a service which can be
          used to store navigation data as well as accessing navigation items
          with their ids from the navigation data. It's a utility service, you
          don't have to use it to make <strong>fuse-navigation</strong> work.
        </p>
        <p>
          <strong>Exported as: </strong><code>fuseVerticalNavigation</code> and
            ...
            <tbody>
              <tr>
                ...
                <td>
                  ...
                  navigation items with ids if you want to access and modify
                  them after generating the navigation.
                </td>
              </tr>
              <tr>
                <td class="text-muted font-mono">
              ...
              <tr>
                ...
                <td>
                  A function that returns a boolean. It gets one parameter which
                  is the navigation item. Returning
                  <code>true</code> from the function will hide the item and
                  <code>false</code> will show it.
                </td>
              </tr>
              <tr>
                <td class="text-muted font-mono">
              ...
              <tr>
                ...
                <td>
                  Whether the supplied link should be parsed as an external
                  link. It must be
                  <strong>true</strong> if you supply a normal, outgoing link in
                  the <strong>link</strong> property.
                </td>
              </tr>
              <tr>
                <td class="text-muted font-mono">
                ...
                <td>
                  Sets the <em>target</em> attribute of the external, outgoing
                  link.
                </td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td>
                  A function to run on navigation item click. It gets one
                  parameter which is the navigation item. Supplying function
                  will
                  <strong>NOT</strong>
                  override the link functionality of the navigation item, they
              ...
              <tr>
                ...
                <td>
                  An object to hold custom data for the navigation item. It can
                  be used for anything such as storing the access role and
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  Appearance of the navigation and its drawer. This is a string
                  type and can be used to override the style of the navigation.
                </td>
                <td>
              ...
              <tr>
                ...
                <td>
                  Whether expanding an expandable navigation item should close
                  other expanded items excluding the active menu item's parent.
                </td>
                <td>
              ...
              <tr>
                ...
                <td>
                  <strong>over</strong> mode can be used to place the drawer on
                  top of the content and <strong>side</strong> mode can be used
                  to push the content and place the drawer next to it.
                </td>
                <td>
              ...
              <tr>
                ...
                <td>
                  Whether the overlay of the drawer is transparent. Only works
                  with
                  <strong>over</strong> mode.
                </td>
                <td>
              ...
              <tr>
                ...
                <td>
                  An event emitted after the appearance of the navigation
                  changed.
                </td>
                <td>-</td>
              </tr>
        ...
        <p>
          Since the entire navigation will be created from the supplied
          navigation data, it's only possible to attach custom content inside
          the navigation drawer using custom content hooks. There are four of
          these hooks;
        </p>
          ...
          <table>
            ...
            <tbody>
              <tr>
                ...
                <td>
                  Fixed header hook. Anything put inside this hook will not
                  scroll with drawer content.
                </td>
              </tr>
              <tr>
                <td class="text-muted font-mono">
                ...
                <td>
                  Header hook. Anything put inside this hook will be scrolled
              ...
              <tr>
                ...
                <td>
                  Fixed footer hook. Anything put inside this hook will not
                  scroll with drawer content.
                </td>
              </tr>
              <tr>
                ...
                <td>
                  Footer hook. Anything put inside this hook will be scrolled
                  with the drawer content.
                </td>
              </tr>
            </tbody>
        ...
        <p>
          The <code>FuseNavigationService</code> provides couple helper methods
          to access navigation items from the navigation data using their ids.
          This is especially useful if you want to change something from any
          item like updating its badge title, hiding or disabling it.
        </p>
            ...
            <mat-tab label="Preview">
              <ng-template matTabContent>
                <button
                  mat-flat-button
                  (click)="
                    getNavItem('documentation.changelog', 'mainNavigation')
                  "
                >
        ...
        <p>
          After accessing a navigation item, you can simply modify the object
          and then call the <code>refresh()</code> method on the
            ...
            <mat-tab label="Preview">
              <ng-template matTabContent>
                <button
                  mat-flat-button
                  (click)="
                    toggleDisabled('documentation.changelog', 'mainNavigation')
                  "
                >
        ...
        <p>
          Sometimes it's best to use more than one set of data and swap between
          them to provide correct navigation. An example use case would be user
          roles. Different roles may require access to different areas and
          rather than showing/hiding individual navigation items, it's best to
          swap the entire navigation data to show a personalized navigation for
          that role.
        </p>
        <div class="example-viewer">
          <div class="title">
