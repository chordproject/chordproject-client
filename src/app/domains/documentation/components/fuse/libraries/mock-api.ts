    ...
    <div class="flex min-w-0 flex-auto flex-col">
      ...
      <div class="prose-sm prose max-w-3xl flex-auto p-6 sm:p-10">
        <p>
          ...
          having to create an actual backend application. This way, you can
          focus on your frontend app and once you finish with the frontend, you
          can create your backend application to provide real API endpoints with
          real data.
        </p>
        <p>
          This not only makes you progress faster and put together your app very
          quickly but you will also know exactly what you will be needing from
          your API.
        </p>
        <p>
          While <strong>MockAPI</strong> is not suitable for every use case or
          for every project, there are some cases that using it would make your
          life easier. These cases are but not limited to:
        </p>
        <ul>
          <li>If you want to focus on the frontend first</li>
          <li>
            If you want to create a mockup of your idea to see if it's going to
            work or not
          </li>
          <li>
            If you want to create a small side project for yourself or for your
            colleagues/company
          </li>
          <li>
            If you need to present your idea to your client or to your boss
        ...
        <p>
          ...
          <em>HttpInterceptor</em> which intercepts all outgoing http requests
          to return a mock response based on user provided callback functions.
          While it intercepts all requests, if the
          <strong>MockAPI</strong> module cannot find a callback function for
          the request type and url, it will let the request to pass through.
          This way, you can use the <strong>MockAPI</strong> along with your
          real API endpoints.
        </p>
        ...
        <p>
          ...
          <em>MockAPI</em> module. This singleton service is used to register
          API endpoints and callbacks. This is the only thing you will need to
          mock API endpoints.
        </p>
        ...
        <div class="bg-card mt-4 rounded shadow">
          ...
          <div class="p-6">
            ...
            <em>Delay (milliseconds)</em> can be set to delay the response.
          </div>
        </div>
        <div class="bg-card mt-4 rounded shadow">
          <div class="text-muted border-b px-6 py-3 font-mono">
        ...
        <p>
          This is the return type of all methods from the service. This class
          instance is not directly accessible. It can only be accessed through
          the
        ...
        <div class="bg-card mt-4 mb-4 rounded shadow">
          ...
          <div class="p-6">
            <p>
              These methods can be used to register the callback function for
              the request. The <em>callback</em> has an access to the outgoing
              <em>HttpRequest</em> which can be used to access anything from the
              request such as form data and headers.
            </p>
            <p>
              You can limit the reply by chaining the
              <code>.replyCount</code> and providing the number of times this
              request should be handled. After the limit has reached, the
              request handler will throw an error and won't let the request to
              pass through. It can be useful for creating one-time-use endpoints
              to test "Reset Password" links or testing an unreachable API
              endpoints and etc.
            </p>
            <p>
              The callbacks must return either an array
              <code>[number, any | string]</code> or an observable that returns
              the said array. The <code>number</code>
              represents the
              <a
        ...
        <p>
          ...
          <strong>MockAPI</strong> module for mocking API endpoints and their
        ...
        >
          ...
          via barrels etc. Majority of these already setup in both Demo and
          Starter apps for you so it's a bit easier to start working with the
          <em>MockAPI</em>.
        </fuse-alert>
        ...
        <p>
          ...
          <code>src/app/mock-api/</code> directory. You can use the same
        ...
        <p>
          After choosing the location, create a sub-directory relevant to your
          endpoint and create 2 files in it; one for the mock class and one for
          the data json:
        </p>
        <p class="text-muted bg-card mt-6 rounded p-6 font-mono shadow">
          src/app/mock-api/<br />
          &nbsp;└─ navigation/<br />
          &nbsp;&nbsp;&nbsp;&nbsp;└─ data.ts<br />
          &nbsp;&nbsp;&nbsp;&nbsp;└─ api.ts
        ...
        <p>
          Edit the <code>api.ts</code> file and inside create an injectable
          class.
        </p>
        <p>
          The <code>FuseMockApi</code> requires one public method called
          <code>registerHandlers()</code> and it must be implemented. It also
        ...
        <p>
          Edit the <code>data.ts</code> file and add your default data as an
        ...
        <p>
          Navigate back to the root of your mock data directory, by default it's
          the <code>src/app/mock-api/</code> directory, and create an
        ...
        <p>
          Edit the <code>index.ts</code> file to create a barrel from the
        ...
        <p>
          You can also set a global delay (ms) to all of your Mock API endpoints
        ...
        <p>
          Now you can consume your mock API endpoints anywhere from your app
          using Angular's <em>HttpClient</em> and the
          <strong>MockAPI</strong> module will catch the requests. If there is a
          matching url and a request type, the <strong>MockAPI</strong> will
          provide the response from the provided callback. If there isn't one,
