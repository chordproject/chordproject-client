  ...
  template: `
    <div class="flex min-w-0 flex-auto flex-col">
      ...
      <div class="prose prose-sm max-w-3xl flex-auto p-6 sm:p-10">
        <p>
          <a href="https://apexcharts.com/" rel="noreferrer" target="_blank"
            >ApexCharts
          </a>
          is a modern and interactive open-source charts library. Fuse supports
          ApexCharts through official
          <a
        ...
        <p>All charts in the Demo app built using <em>ApexCharts</em>.</p>
      </div>
    </div>
  `,
})
