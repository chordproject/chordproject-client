          ...
          <div class="flex flex-wrap items-center font-medium">
            ...
            <div class="ml-1 flex items-center whitespace-nowrap">
              <mat-icon
                ...
                [svgIcon]="'heroicons_mini:chevron-right'"
              ></mat-icon>
              <span class="text-muted ml-1">Authentication</span>
            </div>
          </div>
          <!-- Title -->
          <div class="mt-2">
      ...
      <div class="prose-sm prose max-w-3xl flex-auto p-6 sm:p-10">
        ...
        <ul>
          <li>
            ...
            <p>
              <em>auth</em> and <em>noAuth</em> guards to protect the routes.
            </p>
          </li>
          <li>
            ...
            <p>
              ...
              <em>access token</em> to the header of the requests and catching
              401 responses.
            </p>
          </li>
          <li>
        ...
        <p>
          Before start doing anything within Fuse, prepare your backend API. You
          will need API endpoints for
          <strong>signing in</strong>, <strong>signing out</strong> and
          <strong>refreshing the token</strong>. These will usually be provided
          with your choice of JWT backend implementation by default so you don't
        ...
        <p>
          ...
          <strong>AuthService</strong> file and change the API endpoints so the
        ...
        <p>
          ...
          <strong>local storage</strong>. There are a lot of debates going on
          about whether it is safe or not to store it in the local storage. We
          believe it doesn't matter. Javascript always going to be executed in
          the browser, it doesn't matter where you store the JWT token, whether
          in the local storage or in the memory as a variable, it can always be
          accessed and read!
        </p>
        <p>
          The only thing you have to be careful about is to protect your app
          against attacks like XSS, CSRF or XSRF. Angular does an amazingly good
          job to protect you against these attacks by default but still, you
          have to be careful what to include into your app. And if you happen to
          have a security hole that can cause these attacks and allows attackers
          to run their own Javascript code on your app, local JWT token is going
          to be the least of your worries.
        </p>

        <h2>Refresh token</h2>
        <p>
          <em>Refresh token</em> is another type of token that usually sent with
          the <em>access token</em> when you first login and it allows
          refreshing the <em>access token</em>.
        </p>
        <p>
          We are not going to go into any details about it since you can do your
          own research, but the premise is, you store the
          <em>refresh token</em> in an <strong>HTTPOnly</strong> cookie which
          will be automatically added into the header of any request and can be
          used to sending back a fresh <em>access token</em>
