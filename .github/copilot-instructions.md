...
- Al generar mensajes de commit, escribir siempre en inglés y describir claramente el contenido real incluido en el commit, incluyendo las funcionalidades, correcciones o archivos relevantes cuando aporte contexto. Los cambios en `BACKLOG.md` deben incluirse en el commit cuando existan, pero no deben mencionarse ni describirse en el mensaje. No mencionar nunca `.github/copilot-instructions.md` ni ningún cambio, estado local o actualización relacionado con ese archivo.
